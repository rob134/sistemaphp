...
INSERT INTO `resposta` (`qid`, `ansid`) VALUES
...
INSERT INTO `historico` (`email`, `eid`, `score`, `level`, `sahi`, `wrong`, `date`) VALUES
...
INSERT INTO `opcoes` (`qid`, `option`, `optionid`) VALUES
...
INSERT INTO `questoes` (`eid`, `qid`, `qns`, `choice`, `sn`) VALUES
...
INSERT INTO `simulado` (`eid`, `title`, `sahi`, `wrong`, `total`, `time`, `intro`, `tag`, `date`) VALUES
...
INSERT INTO `usuario` (`name`, `gender`, `college`, `email`, `mob`, `password`) VALUES
